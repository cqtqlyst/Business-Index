...
export default function Home() {
    ...
    const handleSubmit = (event) => {
        alert('Business entered successfully!');
    };
                    ...
                    <form id="myForm" className="bg-black rounded-lg shadow-lg p-8 text-white font-mono">
                        <div className="flex flex-wrap gap-4 justify-center">
                            ...
                            <input
                                type="text"
                                name="fieldName1"
                                placeholder="Enter what email for contact for the business."
                                className="input input-bordered bg-black w-full max-w-md placeholder-white text-center focus:outline-white min-h-[80px] py-20"
                            />
                            <input
                                type="text"
                        ...
                        <button type="submit" className="flex justify-center py-20 text-5xl btn btn-primary mt-4 mx-auto rounded-full bg-black text-white font-mono" onClick={handleSubmit}>
                            Submit
                        </button>
                    </form>
                </div>
