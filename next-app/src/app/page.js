...
export default function Home() {
  ...
  return (
    <div>
      ...
      <Nav/>
      <p className="flex justify-center text-7xl text-bright-purple py-20">Discover. Collaborate. Develop. All in one package.</p>
      <div className="flex justify-center items-center px-20">
        <p className="text-2xl text-bright-purple py-20 mr-8 text-center overflow-hidden" v-text="description">BusinessIndex is an innovative application designed for high schools and organizations across the nation, offering a simple to use platform to catalog and discover businesses that precisely meet their unique requirements.</p>
