  ...
  return (
    <div className="flex bg-gray-800 border border-gray-500 rounded-lg">
      ...
      <div class="w-full rounded-lg shadow border-r border-t border-b border-gray-500">
        <ul
          class="flex flex-wrap text-lg font-normal text-center text-gray-400 border-b border-gray-500 rounded-t-lg"
          id="defaultTab"
        ...
        <div id="defaultTabContent">
          <div
            class={activeTab === "about" ? "p-4 rounded-lg md:p-8" : "hidden"}
            id="about"
            role="tabpanel"
          ...
          >
            ...
            <a
              ...
              class="inline-flex items-center font-medium text-purple-600 hover:text-purple-800 dark:text-purple-500 dark:hover:text-purple-700"
            >
              Visit their website
              <svg
          ...
          >
            ...
            <dl class="grid max-w-screen-xl grid-cols-2 gap-12 mx-auto text-gray-900 sm:grid-cols-3 xl:grid-cols-6 dark:text-white sm:p-8 text-center">
              ...
              <div class="flex flex-col">
                <dt class="mb-2 text-3xl font-extrabold justify-center">
                  {props.years}
                </dt>
                <dd class="text-gray-500 dark:text-gray-400">
                  Years in Business
            ...
            <section class="">
              <div class="py-2 px-2 mx-auto">
                <form action="#" class="space-y-2">
                  ...
                  <button
                    type="submit"
                    class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-purple-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300"
                  >
                    Send message
                  </button>
                </form>
          ...
          <div
            class={activeTab === "ceo" ? "p-4 rounded-lg md:p-8" : "hidden"}
            id="services"
            role="tabpanel"
            aria-labelledby="services-tab"
          >
