        ...
        <nav className= "w-full z-20 top-0 start-0 mt-4 mb-4">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse ">
                    <button 
                        type="button" 
                        className="text-2xl border border-white font-medium rounded-lg px-4 py-2 text-center hover:bg-white hover:text-black"
                        onClick={handleLogin}>
                        Login
                    </button>
                </div>
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul className="text-2xl flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
                        <li>
                            <a href="/" className="block py-2 px-3 text-white rounded md:bg-transparent md:hover:text-gray-400" aria-current="page">Home</a>
                        </li>
                        <li>
